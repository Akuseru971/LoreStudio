...
export default function CreationRitual({
  ...
  const [legendRevealDone, setLegendRevealDone] = useState(skipLegendReveal);
  ...
  }, [book, skipLegendReveal, status.loreReady]);
