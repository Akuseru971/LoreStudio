    ...
    <AnimatePresence>
      {isOpen ? (
        ...
        >
                  ...
                  {showEmailStep ? (
                    ...
                    >
                      ...
                      <section
                        ...
                        className="mt-5 rounded-2xl border border-[#d9bd78]/14 bg-black/22 p-4"
                      >
                        <h3 className="font-cover-title text-base leading-tight text-[#f7ebce]">Preview what you&apos;ll receive</h3>
                        <p className="mt-1.5 text-xs leading-6 text-[#9baabd]">
                          Listen to a sample chapter and open a sample PDF before unlocking your full legend.
                        </p>
          ...
          {showEmailStep && isPdfPreviewOpen ? (
            <motion.div
              key="unlock-pdf-sample-preview"
              className="fixed inset-0 z-[140] flex flex-col bg-[#02030a]/96 p-3 pt-[max(0.75rem,env(safe-area-inset-top))] pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:p-4"
              role="dialog"
              aria-modal="true"
