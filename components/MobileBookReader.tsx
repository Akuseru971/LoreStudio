  ...
  return (
    <div className="mobile-book-shell mx-auto flex w-full max-w-md flex-col">
      <div ref={mobileScrollRef} className="mobile-book-scroll min-h-0 flex-1 overflow-y-auto overscroll-y-contain">
        <article className="mobile-chapter-card mobile-book-page parchment-surface page-shadow overflow-hidden rounded-[1.25rem] border border-[#6b4a24]/15">
          ...
          <div className="mobile-chapter-text-card">
            ...
            <h2 className="page-elegant-title mt-1 text-lg leading-tight text-[#2a1a0c]">{page.title}</h2>
            ...
            <p className="mobile-chapter-body mt-4 text-[15px] leading-[1.55] text-[#352820]">{page.text}</p>

            <footer className="book-meta-label mt-4 flex items-center justify-between text-[0.58rem] uppercase tracking-[0.18em] text-[#6b4a24]/55">
