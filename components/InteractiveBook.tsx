...
export default function InteractiveBook({
  ...
  const fetchImageForPage = useCallback(
    ...
    [accessToken, safeBook, imageCache, isPremium],
  );
  ...
  }, [accessToken, safePages, fetchImageForPage, isPremium]);
  ...
  }, [accessToken, activePageIndex, fetchImageForPage, illustratedPages, isOpen]);
